...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2021 at 06:21 PM
...
('root', '[{\"db\":\"readingfromsql\",\"table\":\"writtenres\"},{\"db\":\"schoolregform\",\"table\":\"resultsv2\"},{\"db\":\"schoolregform\",\"table\":\"results\"},{\"db\":\"myfirstdatabase\",\"table\":\"student\"}]');
...
('root', '2021-05-07 16:21:08', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
--
CREATE DATABASE IF NOT EXISTS `readingfromsql` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `readingfromsql`;
...
--
CREATE DATABASE IF NOT EXISTS `schoolregform` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `schoolregform`;
...
CREATE TABLE `results` (
  ...
  `birth date` varchar(8) NOT NULL,
  `gender` int(7) NOT NULL,
  `ethnicity` varchar(20) NOT NULL,
  `email address` varchar(20) NOT NULL,
  `Entry year` varchar(4) NOT NULL,
  `grade` varchar(2) NOT NULL,
  `semester` varchar(2) NOT NULL,
  `appliedOrNot` int(1) NOT NULL,
  `street address` varchar(15) NOT NULL,
  `street address line 2` varchar(15) NOT NULL,
  `city` varchar(20) NOT NULL,
  `State/Province` varchar(20) NOT NULL,
  `Postal/zip code` varchar(7) NOT NULL,
  `Home Phone Number` int(15) NOT NULL,
  `Cell Phone Number` int(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- Database: `teting`
--
CREATE DATABASE IF NOT EXISTS `teting` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `teting`;
--
-- Database: `textdb`
--
CREATE DATABASE IF NOT EXISTS `textdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `textdb`;
--
-- Database: `textxd`
--
CREATE DATABASE IF NOT EXISTS `textxd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `textxd`;
--
-- Database: `ttt`
--
CREATE DATABASE IF NOT EXISTS `ttt` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ttt`;
COMMIT;
